...
if (isset($_POST['submit'])) {
    ...
    if ($num && $num['id'] > 0) {
        ...
        $_SESSION['id']     = $num['id'];
        $_SESSION['role']   = 'doctor';   // ← role-based flag
...
<head>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .login-card{background:#fff;border-radius:24px;padding:44px 40px;box-shadow:0 30px 80px rgba(0,0,0,0.3);}
        .login-logo{text-align:center;margin-bottom:32px;}
        .login-logo .logo-icon{width:64px;height:64px;background:linear-gradient(135deg,#0085bc,#003f72);border-radius:18px;
        ...
        .role-badge{display:inline-flex;align-items:center;gap:6px;background:rgba(0,133,188,0.1);color:#0077b6;
        ...
        .input-wrap input:focus{outline:none;border-color:#0077b6;background:#fff;box-shadow:0 0 0 3px rgba(0,119,182,0.12);}
        .forgot{font-size:0.8rem;color:#0077b6;float:right;margin-top:4px;}
        .btn-login{width:100%;background:linear-gradient(135deg,#0085bc,#003f72);color:#fff;border:none;border-radius:12px;
                   padding:13px;font-size:0.95rem;font-weight:600;font-family:'Poppins',sans-serif;cursor:pointer;
                   transition:all 0.3s;margin-top:8px;}
        .btn-login:hover{transform:translateY(-2px);box-shadow:0 8px 25px rgba(0,119,182,0.4);}
        ...
        .portal-link:hover{border-color:#0077b6;color:#0077b6;background:rgba(0,119,182,0.04);}
...
<div class="login-wrap">
    <div class="login-card">
        <div class="login-logo">
            <div class="logo-icon"><i class="fa fa-stethoscope"></i></div>
            <h2>HMS<span style="color:#0077b6">+</span></h2>
            <p>Hospital Management System</p>
        </div>
        <div class="text-center"><span class="role-badge"><i class="fa fa-user-md"></i> Doctor Portal</span></div>
        ...
        <form method="post" autocomplete="off">
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" name="username" placeholder="Doctor email" required>
                </div>
            </div>
            <div class="form-group">
            ...
            <button type="submit" name="submit" class="btn-login">
                <i class="fa fa-sign-in"></i> Sign In as Doctor
            </button>
        </form>
