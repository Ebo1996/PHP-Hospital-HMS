...
$pageTitle='About Us';$pageIcon='fa-info-circle';
if(isset($_POST['submit'])){
  $pagetitle=mysqli_real_escape_string($con,$_POST['pagetitle']);
  $pagedes=mysqli_real_escape_string($con,$_POST['pagedes']);
  $q=mysqli_query($con,"UPDATE tblpage SET PageTitle='$pagetitle',PageDescription='$pagedes' WHERE PageType='aboutus'");
  $msg=$q?'About Us updated successfully.':'Something went wrong. Please try again.';
  $mtype=$q?'success':'error';
}
?><!DOCTYPE html><html lang="en"><head><title>About Us — HMS+ Admin</title><?php include('include/head.php');?></head><body>
<div id="app"><?php include('include/sidebar.php');?>
<div class="app-content"><?php include('include/header.php');?>
<div class="main-content">
<div class="adm-breadcrumb"><i class="fa fa-home"></i><a href="dashboard.php">Dashboard</a><span class="sep">/</span><span class="cur">About Us</span></div>
...
<div class="adm-card">
  <div class="adm-card-header"><div class="ch-left"><i class="fa fa-info-circle"></i><h5>Update About Us Content</h5></div></div>
  <div class="adm-card-body">
  <form method="post">
    <?php $ret=mysqli_query($con,"SELECT * FROM tblpage WHERE PageType='aboutus'");
    ...
    <div class="adm-fg">
      ...
      <textarea name="pagedes" class="adm-input" rows="12"><?php echo htmlspecialchars($row['PageDescription']);?></textarea>
    </div>
    <?php endwhile;?>
