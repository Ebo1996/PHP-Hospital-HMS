...
<head>
 ...
 <link rel="icon" href="assets/images/medical.png" type="image/x-icon" />
                ...
                <div class="row">
                    ...
                    <div id="menu" class="col-lg-8 col-md-9 d-none d-md-block nav-item">
                        <ul>
                            ...
                            <li><a href="#logins">Logins/signup</a></li>  
                        </ul>
                    </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <!-- <div class="carousel-item ">
                    <img class="d-block w-100" src="assets/images/slider/imageeee.jpg" alt="Second slide">
                    <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Hospital Management System</h5>
            
                        <h2 style="padding-top: 250px; font-weight: bold; font-size: 5rem;">Fayyaan keenyaa faaya Keenyaa</h2>
                    </div>
                </div> -->
                
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/imageeee.jpg" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Hospital Management System</h5>
  ...
  <section id="services" class="key-features department">
    ...
    <div class="row no-margin">
        <!-- Image Column -->
        <div class="col-6 image-bg no-padding">
            <img src="assets/images/gallery/gallery_12.jpg" alt="About Us Image" class="img-fluid" style="width: 100%; height: auto;">
        </div>

        <!-- Content Column -->
        <div class="col-6 abut-yoiu">
